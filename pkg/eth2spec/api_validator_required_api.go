...
*/
func (a *ValidatorRequiredApiApiService) GetGenesis(ctx _context.Context) (InlineResponse200, *_nethttp.Response, error) {
	var (
...
*/
func (a *ValidatorRequiredApiApiService) GetStateFork(ctx _context.Context, stateId string) (InlineResponse2002, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *ValidatorRequiredApiApiService) GetSyncingStatus(ctx _context.Context) (InlineResponse20019, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
