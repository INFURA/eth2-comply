...
*/
func (a *BeaconApiService) GetBlock(ctx _context.Context, blockId string) (GetBlockResponse, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/eth/v1/beacon/blocks/{block_id}"
...
func (a *BeaconApiService) GetBlockAttestations(ctx _context.Context, blockId string) (GetBlockAttestationsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/eth/v1/beacon/blocks/{block_id}/attestations"
	localVarPath = strings.Replace(localVarPath, "{"+"block_id"+"}", _neturl.QueryEscape(parameterToString(blockId, "")) , -1)
...
*/
func (a *BeaconApiService) GetBlockHeader(ctx _context.Context, blockId string) (GetBlockHeaderResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GetBlockHeaderResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/eth/v1/beacon/headers/{block_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"block_id"+"}", _neturl.QueryEscape(parameterToString(blockId, "")) , -1)
...
func (a *BeaconApiService) GetBlockHeaders(ctx _context.Context, localVarOptionals *GetBlockHeadersOpts) (GetBlockHeadersResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GetBlockHeadersResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/eth/v1/beacon/headers"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
*/
func (a *BeaconApiService) GetBlockRoot(ctx _context.Context, blockId string) (GetBlockRootResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GetBlockRootResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/eth/v1/beacon/blocks/{block_id}/root"
	localVarPath = strings.Replace(localVarPath, "{"+"block_id"+"}", _neturl.QueryEscape(parameterToString(blockId, "")) , -1)
...
func (a *BeaconApiService) GetEpochCommittees(ctx _context.Context, stateId string, epoch string, localVarOptionals *GetEpochCommitteesOpts) (GetEpochCommitteesResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GetEpochCommitteesResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/eth/v1/beacon/states/{state_id}/committees/{epoch}"
...
*/
func (a *BeaconApiService) GetGenesis(ctx _context.Context) (GetGenesisResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *BeaconApiService) GetStateFinalityCheckpoints(ctx _context.Context, stateId string) (GetStateFinalityCheckpointsResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GetStateFinalityCheckpointsResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/eth/v1/beacon/states/{state_id}/finality_checkpoints"
	localVarPath = strings.Replace(localVarPath, "{"+"state_id"+"}", _neturl.QueryEscape(parameterToString(stateId, "")) , -1)
...
*/
func (a *BeaconApiService) GetStateFork(ctx _context.Context, stateId string) (GetStateForkResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *BeaconApiService) GetStateRoot(ctx _context.Context, stateId string) (GetStateRootResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GetStateRootResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/eth/v1/beacon/states/{state_id}/root"
	localVarPath = strings.Replace(localVarPath, "{"+"state_id"+"}", _neturl.QueryEscape(parameterToString(stateId, "")) , -1)
...
func (a *BeaconApiService) GetStateValidators(ctx _context.Context, stateId string, localVarOptionals *GetStateValidatorsOpts) (GetStateValidatorsResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GetStateValidatorsResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/eth/v1/beacon/states/{state_id}/validators"
	localVarPath = strings.Replace(localVarPath, "{"+"state_id"+"}", _neturl.QueryEscape(parameterToString(stateId, "")) , -1)
